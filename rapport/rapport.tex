...
\paragraph{}Soit $X$ une variable aléatoire, qui suit une distribution géométrique, représentant la guérison d'un individu une fois infecté. On a: $$X \sim \mathcal{G}(\mu)$$ avec $\mu$ la probabilité de guérison.
