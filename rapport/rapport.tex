...
\noindent Le programme retourne le graphique de la figure 5 ainsi que le temps moyen de disparition des individus infectieux y correspondant qui est de 44,652 unités de temps avec les probabilités $\beta$ et $\mu$ fixées au valeurs suggérées.
