...
Deux autres exécutions avec une précision égale à l'epsilon machine sur 32 bits ont données 74 avec la matrice $W_{lin}$ et 73 avec l'autre matrice, $W_{full}$.
...
\begin{figure}[H]
	...
	\caption{Evolution des proportions d'individus dans chacune des catégorie au cours du temps suivant un modèle représenté par une matrice d'adjacence $W_{big}$ de taille $2000 \times 2000$ générée aléatoirement selon un modèle "scale-free" avec une proportion initiale d'individus vaccinés de 55\%.}
\end{figure}
